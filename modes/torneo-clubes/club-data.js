(() => {
  ...
  window.clubSquads = [
    ...
    S("ucl-ajax-1995", "Ajax", 1995, UCL, 92, [
      P("Edwin van der Sar", "POR", 90), P("Fred Grim", "POR", 76),
      P("Michael Reiziger", "LD", 86), P("Frank de Boer", "DFC", 91), P("Danny Blind", "DFC", 90), P("Winston Bogarde", "LI", 84), P("Sonny Silooy", "LD", 82),
      P("Edgar Davids", "MCD", 90), P("Clarence Seedorf", "MC", 89), P("Ronald de Boer", "MCO", 88), P("Jari Litmanen", "MCO", 93), P("Nwankwo Kanu", "DC", 85),
      P("Finidi George", "ED", 87), P("Marc Overmars", "EI", 89), P("Patrick Kluivert", "DC", 88), P("Peter van Vossen", "EI", 80),
    ]),
    S("ucl-juventus-1996", "Juventus", 1996, UCL, 91, [
      P("Angelo Peruzzi", "POR", 90), P("Michelangelo Rampulla", "POR", 76),
      P("Moreno Torricelli", "LD", 85), P("Ciro Ferrara", "DFC", 91), P("Pietro Vierchowod", "DFC", 86), P("Gianluca Pessotto", "LI", 84), P("Massimo Carrera", "DFC", 82),
      P("Antonio Conte", "MC", 88), P("Didier Deschamps", "MCD", 90), P("Paulo Sousa", "MC", 88), P("Angelo Di Livio", "ED", 86), P("Vladimir Jugovic", "MC", 87),
      P("Alessandro Del Piero", "EI", 92, ["EI", "DC"]), P("Gianluca Vialli", "DC", 90), P("Fabrizio Ravanelli", "DC", 88), P("Michele Padovano", "DC", 80),
    ]),
    S("ucl-porto-2004", "Porto", 2004, UCL, 90, [
      P("Vitor Baia", "POR", 88), P("Nuno", "POR", 76),
      P("Paulo Ferreira", "LD", 87), P("Ricardo Carvalho", "DFC", 92), P("Jorge Costa", "DFC", 86), P("Nuno Valente", "LI", 85), P("Pedro Emanuel", "DFC", 82),
      P("Costinha", "MCD", 88), P("Maniche", "MC", 90), P("Deco", "MCO", 93), P("Dmitri Alenichev", "MC", 84), P("Pedro Mendes", "MC", 82),
      P("Carlos Alberto", "MCO", 85), P("Derlei", "DC", 87), P("Benni McCarthy", "DC", 86), P("Ricardo Quaresma", "ED", 82),
    ]),
    S("ucl-monaco-2004", "Monaco", 2004, UCL, 87, [
      P("Flavio Roma", "POR", 84), P("Tony Sylva", "POR", 77),
      P("Hugo Ibarra", "LD", 84), P("Julien Rodriguez", "DFC", 82), P("Sebastien Squillaci", "DFC", 84), P("Patrice Evra", "LI", 86), P("Gael Givet", "DFC", 83),
      P("Lucas Bernardi", "MCD", 84), P("Akis Zikos", "MCD", 83), P("Ludovic Giuly", "ED", 89), P("Jerome Rothen", "EI", 86), P("Edouard Cisse", "MC", 80),
      P("Fernando Morientes", "DC", 90), P("Dado Prso", "DC", 86), P("Shabani Nonda", "DC", 84), P("Emmanuel Adebayor", "DC", 80),
    ]),
    S("ucl-liverpool-2005", "Liverpool", 2005, UCL, 90, [
      P("Jerzy Dudek", "POR", 86), P("Scott Carson", "POR", 76),
      P("Steve Finnan", "LD", 84), P("Jamie Carragher", "DFC", 90), P("Sami Hyypia", "DFC", 88), P("Djimi Traore", "LI", 80), P("John Arne Riise", "LI", 85),
      P("Dietmar Hamann", "MCD", 86), P("Xabi Alonso", "MC", 90), P("Steven Gerrard", "MC", 94), P("Luis Garcia", "MCO", 87), P("Vladimir Smicer", "MCO", 83),
      P("Harry Kewell", "EI", 84), P("Milan Baros", "DC", 86), P("Djibril Cisse", "DC", 84), P("Fernando Morientes", "DC", 83),
    ]),
    S("ucl-milan-2007", "Milan", 2007, UCL, 93, [
      P("Dida", "POR", 88), P("Zeljko Kalac", "POR", 76),
      P("Massimo Oddo", "LD", 86), P("Alessandro Nesta", "DFC", 93), P("Paolo Maldini", "DFC", 92, ["DFC", "LI"]), P("Marek Jankulovski", "LI", 84), P("Kakha Kaladze", "DFC", 83),
      P("Gennaro Gattuso", "MCD", 89), P("Andrea Pirlo", "MC", 95), P("Clarence Seedorf", "MC", 91), P("Kaka", "MCO", 97), P("Massimo Ambrosini", "MC", 85),
      P("Filippo Inzaghi", "DC", 90), P("Alberto Gilardino", "DC", 84), P("Ronaldo", "DC", 86), P("Serginho", "EI", 82),
    ]),
    S("ucl-real-madrid-2017", "Real Madrid", 2017, UCL, 97, [
      P("Keylor Navas", "POR", 90), P("Kiko Casilla", "POR", 78),
      P("Dani Carvajal", "LD", 90), P("Sergio Ramos", "DFC", 95), P("Raphael Varane", "DFC", 89), P("Marcelo", "LI", 93), P("Nacho", "DFC", 84),
      P("Casemiro", "MCD", 91), P("Luka Modric", "MC", 94), P("Toni Kroos", "MC", 94), P("Isco", "MCO", 90), P("James Rodriguez", "MCO", 86),
      P("Gareth Bale", "ED", 90), P("Cristiano Ronaldo", "EI", 98, ["EI", "DC"]), P("Karim Benzema", "DC", 91), P("Marco Asensio", "ED", 86),
    ]),
    S("ucl-juventus-2017", "Juventus", 2017, UCL, 93, [
      P("Gianluigi Buffon", "POR", 94), P("Norberto Neto", "POR", 78),
      P("Dani Alves", "LD", 90), P("Leonardo Bonucci", "DFC", 92), P("Giorgio Chiellini", "DFC", 92), P("Alex Sandro", "LI", 89), P("Andrea Barzagli", "DFC", 86),
      P("Miralem Pjanic", "MC", 88), P("Sami Khedira", "MC", 87), P("Claudio Marchisio", "MC", 86), P("Juan Cuadrado", "ED", 87), P("Mario Mandzukic", "EI", 88),
      P("Paulo Dybala", "MCO", 91, ["MCO", "DC"]), P("Gonzalo Higuain", "DC", 92), P("Marko Pjaca", "EI", 80), P("Stefano Sturaro", "MC", 80),
    ]),
    S("ucl-liverpool-2019", "Liverpool", 2019, UCL, 95, [
      P("Alisson", "POR", 93), P("Simon Mignolet", "POR", 78),
      P("Trent Alexander-Arnold", "LD", 90), P("Virgil van Dijk", "DFC", 96), P("Joel Matip", "DFC", 87), P("Andrew Robertson", "LI", 91), P("Joe Gomez", "DFC", 84),
      P("Fabinho", "MCD", 89), P("Jordan Henderson", "MC", 87), P("Georginio Wijnaldum", "MC", 88), P("James Milner", "MC", 84), P("Naby Keita", "MC", 83),
      P("Mohamed Salah", "ED", 94), P("Sadio Mane", "EI", 93), P("Roberto Firmino", "DC", 91), P("Divock Origi", "DC", 83),
    ]),
    S("ucl-tottenham-2019", "Tottenham", 2019, UCL, 89, [
      P("Hugo Lloris", "POR", 89), P("Paulo Gazzaniga", "POR", 77),
      P("Kieran Trippier", "LD", 84), P("Toby Alderweireld", "DFC", 88), P("Jan Vertonghen", "DFC", 88), P("Danny Rose", "LI", 83), P("Davinson Sanchez", "DFC", 84),
      P("Moussa Sissoko", "MC", 85), P("Harry Winks", "MC", 82), P("Christian Eriksen", "MCO", 90), P("Dele Alli", "MCO", 86), P("Eric Dier", "MCD", 82),
      P("Son Heung-min", "EI", 91), P("Lucas Moura", "ED", 87), P("Harry Kane", "DC", 93), P("Fernando Llorente", "DC", 82),
    ]),
    S("lib-corinthians-2012", "Corinthians", 2012, LIB, 90, [
      P("Cassio", "POR", 88), P("Julio Cesar", "POR", 76),
      P("Alessandro", "LD", 83), P("Chicao", "DFC", 85), P("Leandro Castan", "DFC", 86), P("Fabio Santos", "LI", 84), P("Wallace", "DFC", 80),
      P("Ralf", "MCD", 86), P("Paulinho", "MC", 88), P("Danilo", "MCO", 86), P("Alex", "MCO", 84), P("Douglas", "MCO", 83),
      P("Jorge Henrique", "EI", 84), P("Emerson Sheik", "DC", 88, ["DC", "EI"]), P("Liedson", "DC", 84), P("Willian", "ED", 82),
    ]),
    S("lib-boca-2012", "Boca Juniors", 2012, LIB, 87, [
      P("Agustin Orion", "POR", 85), P("Sebastian Sosa", "POR", 76),
      P("Facundo Roncaglia", "LD", 84), P("Rolando Schiavi", "DFC", 85), P("Juan Insaurralde", "DFC", 82), P("Clemente Rodriguez", "LI", 84), P("Matias Caruzzo", "DFC", 80),
      P("Leandro Somoza", "MCD", 83), P("Pablo Ledesma", "MC", 82), P("Juan Roman Riquelme", "MCO", 91), P("Walter Erviti", "MC", 84), P("Cristian Chavez", "MCO", 80),
      P("Pablo Mouche", "ED", 83), P("Dario Cvitanich", "DC", 84), P("Santiago Silva", "DC", 85), P("Nicolas Blandi", "DC", 80),
    ]),
    S("lib-atletico-mineiro-2013", "Atletico Mineiro", 2013, LIB, 91, [
      P("Victor", "POR", 89), P("Giovanni", "POR", 74),
      P("Marcos Rocha", "LD", 85), P("Rever", "DFC", 86), P("Leonardo Silva", "DFC", 86), P("Richarlyson", "LI", 82), P("Junior Cesar", "LI", 81),
      P("Pierre", "MCD", 84), P("Leandro Donizete", "MC", 83), P("Bernard", "EI", 88), P("Ronaldinho", "MCO", 93), P("Josue", "MCD", 82),
      P("Diego Tardelli", "ED", 87), P("Jo", "DC", 88), P("Luan", "ED", 83), P("Guilherme", "MCO", 82),
    ]),
    S("lib-olimpia-2013", "Olimpia", 2013, LIB, 84, [
      P("Martin Silva", "POR", 84), P("Diego Barreto", "POR", 77),
      P("Julio Manzur", "LD", 80), P("Herminio Miranda", "DFC", 82), P("Salustiano Candia", "DFC", 81), P("Nelson Benitez", "LI", 80), P("Carlos Humberto Paredes", "MCD", 82),
      P("Richard Ortiz", "MC", 83), P("Eduardo Aranda", "MC", 81), P("Alejandro Silva", "ED", 82), P("Juan Manuel Salgueiro", "MCO", 84), P("Matias Gimenez", "EI", 80),
      P("Fredy Bareiro", "DC", 83), P("Juan Carlos Ferreyra", "DC", 82), P("Enzo Prono", "DC", 78), P("Wilson Pittoni", "MC", 79),
    ]),
    S("lib-san-lorenzo-2014", "San Lorenzo", 2014, LIB, 88, [
      P("Sebastian Torrico", "POR", 86), P("Cristian Alvarez", "POR", 75),
      P("Julio Buffarini", "LD", 84), P("Mauro Cetto", "DFC", 83), P("Santiago Gentiletti", "DFC", 85), P("Emmanuel Mas", "LI", 84), P("Walter Kannemann", "DFC", 81),
      P("Juan Mercier", "MCD", 85), P("Nestor Ortigoza", "MC", 86), P("Leandro Romagnoli", "MCO", 87), P("Ignacio Piatti", "EI", 88), P("Enzo Kalinski", "MC", 80),
      P("Hector Villalba", "ED", 84), P("Mauro Matos", "DC", 84), P("Martin Cauteruccio", "DC", 82), P("Nicolas Blandi", "DC", 80),
    ]),
    S("lib-nacional-paraguay-2014", "Nacional", 2014, LIB, 82, [
      P("Ignacio Don", "POR", 82), P("Eduardo Hodas", "POR", 73),
      P("Marcos Melgarejo", "LD", 79), P("Raul Piris", "DFC", 80), P("David Mendoza", "DFC", 80), P("Silvio Torales", "LI", 79), P("Julian Benitez", "EI", 80),
      P("Marcos Riveros", "MCD", 81), P("Derlis Oru?", "MC", 80), P("Juan Arg?ello", "MC", 78), P("Fredy Bareiro", "DC", 82), P("Brian Montenegro", "DC", 81),
      P("Juli?n Ben?tez", "ED", 80), P("Gustavo Cristaldo", "MCO", 79), P("Carlos Ruiz Peralta", "DC", 78), P("Hugo Lusardi", "MCO", 79),
    ]),
    S("lib-atletico-nacional-2016", "Atletico Nacional", 2016, LIB, 90, [
      P("Franco Armani", "POR", 89), P("Cristian Bonilla", "POR", 76),
      P("Daniel Bocanegra", "LD", 84), P("Davinson Sanchez", "DFC", 86), P("Alexis Henriquez", "DFC", 85), P("Farid Diaz", "LI", 83), P("Felipe Aguilar", "DFC", 82),
      P("Alexander Mejia", "MCD", 85), P("Sebastian Perez", "MC", 84), P("Macnelly Torres", "MCO", 88), P("Alejandro Guerra", "MCO", 87), P("Diego Arias", "MCD", 81),
      P("Marlos Moreno", "EI", 86), P("Orlando Berrio", "ED", 85), P("Miguel Borja", "DC", 88), P("Jonathan Copete", "EI", 84),
    ]),
    S("lib-independiente-del-valle-2016", "Independiente del Valle", 2016, LIB, 84, [
      P("Librado Azcona", "POR", 83), P("Daniel Azcona", "POR", 73),
      P("Christian Nunez", "LD", 80), P("Arturo Mina", "DFC", 83), P("Luis Caicedo", "DFC", 82), P("Luis Ayala", "LI", 80), P("Emiliano Tellechea", "MC", 79),
      P("Jefferson Orejuela", "MCD", 82), P("Junior Sornoza", "MCO", 84), P("Mario Rizotto", "MC", 80), P("Julio Angulo", "ED", 81), P("Bryan Cabezas", "EI", 83),
      P("Jose Angulo", "DC", 84), P("Gabriel Cortez", "MCO", 80), P("Daniel Angulo", "DC", 79), P("Pineida", "LI", 78),
    ]),
    S("lib-gremio-2017", "Gremio", 2017, LIB, 90, [
      P("Marcelo Grohe", "POR", 88), P("Paulo Victor", "POR", 76),
      P("Edilson", "LD", 84), P("Pedro Geromel", "DFC", 88), P("Walter Kannemann", "DFC", 86), P("Bruno Cortez", "LI", 82), P("Bressan", "DFC", 79),
      P("Michel", "MCD", 83), P("Arthur", "MC", 88), P("Maicon", "MC", 85), P("Luan", "MCO", 90), P("Ramiro", "MC", 83),
      P("Everton", "EI", 86), P("Fernandinho", "ED", 84), P("Lucas Barrios", "DC", 84), P("Jael", "DC", 80),
    ]),
    S("lib-lanus-2017", "Lanus", 2017, LIB, 85, [
      P("Esteban Andrada", "POR", 84), P("Fernando Monetti", "POR", 75),
